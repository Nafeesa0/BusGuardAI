...
class ViewAccident extends StatefulWidget {
  const ViewAccident({super.key});

  @override
  State<ViewAccident> createState() => _ViewAccidentState();
}

class _ViewAccidentState extends State<ViewAccident> {
  _ViewAccidentState() {
    fetchAccidents();
  }
  ...
  Future<void> fetchAccidents() async {
    try {
      ...
      String url = ip + "viewaccidentflutter/";
      print(url);
