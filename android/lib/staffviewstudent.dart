...
//
// class staffChildPage extends StatefulWidget {
//   @override
//   _staffChildPageState createState() => _staffChildPageState();
// }
//
// class _staffChildPageState extends State<staffChildPage> {
//   List<String> ccid_ = <String>[];
//   List<String> name_ = <String>[];
//   List<String> gender_ = <String>[];
//
//   _staffChildPageState() {
//     load();
//   }
//
...
//             context,
//             MaterialPageRoute(
//               builder: (context) => NewstaffChildPagePage(),
//             ),
//           ).then((_) => load());
//         },
...
// }
//
// class NewstaffChildPagePage extends StatefulWidget {
//   @override
//   _NewstaffChildPagePageState createState() => _NewstaffChildPagePageState();
// }
//
// class _NewstaffChildPagePageState extends State<NewstaffChildPagePage> {
//   final TextEditingController _staffChildPageController = TextEditingController();
//   final TextEditingController _genderController = TextEditingController();
//
//   @override
//   void dispose() {
//     _staffChildPageController.dispose();
...
//           children: [
//             TextField(
//               controller: _staffChildPageController,
...
//                 String namee = _staffChildPageController.text;
...
//                       context, MaterialPageRoute(builder: (context) => staffChildPage()));
//                 } else {
//                   ScaffoldMessenger.of(context).showSnackBar(
...
import 'dart:convert';
import 'package:bustracking/send%20requesest.dart';
import 'package:bustracking/sendnotification.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) => staffsendnotification()),
                            );
