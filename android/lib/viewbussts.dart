...
//
//
// class viewbususersts extends StatelessWidget {
//   const viewbususersts({super.key});
//
...
//       ),
//       home: const viewbususerstspagePage(title: 'Flutter Demo Home Page'),
//       routes: {
//
//       },
//     );
...
// }
//
// class viewbususerstspagePage extends StatefulWidget {
//   const viewbususerstspagePage({super.key, required this.title});
//
...
//
//   @override
//   State<viewbususerstspagePage> createState() => _viewbususerstspagePage();
// }
//
// class _viewbususerstspagePage extends State<viewbususerstspagePage> {
//   int _counter = 0;
//
//   _viewbususerstspagePage() {
//     view_college();
//   }
//
//
...
class viewbususersts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const viewbususerstspagePage(title: 'View All Buses'),
    );
  }
}
